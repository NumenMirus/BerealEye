...
import pendulum
import hashlib
from berealeye.BeFake.models.picture import Picture

from berealeye.BeFake.models.post import Post
from berealeye.BeFake.models.memory import Memory
from berealeye.BeFake.models.user import User
...
class BeFake:
    ...
    def send_otp(self, phone: str) -> None:
        ...
        try:
            ...
            print("[ERROR]: {m}".format(m = res['error']['message']))
            exit(-1)
